...
<a<?php echo ' href="'. esc_url( get_permalink() ) .'"';?>><div id="bouton_voir">Voir produit...</div></a>

	<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
		<br><br><div class="mk-shop-item-detail">
			<?php
			 	global $mk_options;
			...
			<h3 class="prod-title"><a href="<?php echo esc_url( get_permalink() ); ?>"><?php the_title(); ?></a></h3> <!-- //iloop -->
			<?php if($mk_options['woocommerce_catalog'] == 'false') { 
