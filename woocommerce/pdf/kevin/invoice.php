...
<table class="order-details">
	<thead>
		<tr>
			<th class="product border" style="color:white">Références</th>
			<th class="product"><?php _e('Product', 'wpo_wcpdf'); ?></th>
			<th class="quantity"><?php _e('Quantity', 'wpo_wcpdf'); ?></th>
			<th class="price"><?php _e('Price', 'wpo_wcpdf'); ?> TTC</th>
		</tr>
	</thead>
	<tbody class="border">
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $wpo_wcpdf->export->template_type, $wpo_wcpdf->export->order, $item_id ); ?>">
			<td class="border">
					<strong style="text-align:center"><?php echo $item['sku']; ?></strong>
				</td>
			<td class="product">
			...
			<td class="quantity border"><?php echo $item['quantity']; ?></td>
			<td class="price border"><?php echo $item['order_price']; ?> </td>
		</tr>
